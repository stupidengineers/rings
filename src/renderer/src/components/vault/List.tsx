...
export default function List({ title, initialItems, onDelete, onEdit, layoutId }: ListProps) {
  const [items, setItems] = React.useState<ListItem[]>(initialItems);

  return (
    <Card showOptions={true} onDelete={onDelete} onEdit={onEdit} layoutId={layoutId}>
